...
/*********************************************************************************************/
      ...
      targetPosition = new THREE.Vector3(0, 0, 0).addVectors(camPos,targetPosition);
...
/*********************************************************************************************/
  ...
  this.getTarget = function(){
    return owl.deepCopy(this.target);
  }
  ...
  this.updateCords = function(pos){
    ...
    var targetPosition = this.getCartesian(tmpSpherical[0], tmpSpherical[1], r);
      targetPosition    = new THREE.Vector3(0, 0, 0).addVectors(targetPosition, camPos);

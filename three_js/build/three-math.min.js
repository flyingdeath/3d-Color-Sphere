...
this.x=(a[0]*b+a[4]*c+a[8]*d+a[12])*e;this.y=(a[1]*b+a[5]*c+a[9]*d+a[13])*e;this.z=(a[2]*b+a[6]*c+a[10]*d+a[14])*e;return this},applyQuaternion:function(a){var b=this.x,c=this.y,d=this.z,e=a.x,g=a.y,f=a.z,a=a.w,h=a*b+g*d-f*c,i=a*c+f*b-e*d,j=a*d+e*c-g*b,b=-e*b-g*c-f*d;this.x=h*a+b*-e+i*-f-j*-g;this.y=i*a+b*-g+j*-e-h*-f;this.z=j*a+b*-f+h*-g-i*-e;return this},applyEuler:function(){var a=new THREE.Quaternion;return function(b,c){var d=a.setFromEuler(b,c);this.applyQuaternion(d);return this}}(),applyAxisAngle:function(){var a=
...
d=a.x,e=a.y,g=a.z,f=Math.cos(d),d=Math.sin(d),h=Math.cos(e),e=Math.sin(e),i=Math.cos(g),g=Math.sin(g);if(void 0===b||"XYZ"===b){var j=f*i,k=f*g,l=d*i,m=d*g;c[0]=h*i;c[4]=-h*g;c[8]=e;c[1]=k+l*e;c[5]=j-m*e;c[9]=-d*h;c[2]=m-j*e;c[6]=l+k*e;c[10]=f*h}else"YXZ"===b?(j=h*i,k=h*g,l=e*i,m=e*g,c[0]=j+m*d,c[4]=l*d-k,c[8]=f*e,c[1]=f*g,c[5]=f*i,c[9]=-d,c[2]=k*d-l,c[6]=m+j*d,c[10]=f*h):"ZXY"===b?(j=h*i,k=h*g,l=e*i,m=e*g,c[0]=j-m*d,c[4]=-f*g,c[8]=l+k*d,c[1]=k+l*d,c[5]=f*i,c[9]=m-j*d,c[2]=-f*e,c[6]=d,c[10]=f*h):
"ZYX"===b?(j=f*i,k=f*g,l=d*i,m=d*g,c[0]=h*i,c[4]=l*e-k,c[8]=j*e+m,c[1]=h*g,c[5]=m*e+j,c[9]=k*e-l,c[2]=-e,c[6]=d*h,c[10]=f*h):"YZX"===b?(j=f*h,k=f*e,l=d*h,m=d*e,c[0]=h*i,c[4]=m-j*g,c[8]=l*g+k,c[1]=g,c[5]=f*i,c[9]=-d*i,c[2]=-e*i,c[6]=k*g+l,c[10]=j-m*g):"XZY"===b&&(j=f*h,k=f*e,l=d*h,m=d*e,c[0]=h*i,c[4]=-g,c[8]=e*i,c[1]=j*g+m,c[5]=f*i,c[9]=k*g-l,c[2]=l*g-k,c[6]=d*i,c[10]=m*g+j);return this},setRotationFromQuaternion:function(a){var b=this.elements,c=a.x,d=a.y,e=a.z,g=a.w,f=c+c,h=d+d,i=e+e,a=c*f,j=c*h,
c=c*i,k=d*h,d=d*i,e=e*i,f=g*f,h=g*h,g=g*i;b[0]=1-(k+e);b[4]=j-g;b[8]=c+h;b[1]=j+g;b[5]=1-(a+e);b[9]=d-f;b[2]=c-h;b[6]=d+f;b[10]=1-(a+k);return this},lookAt:function(){var a=new THREE.Vector3,b=new THREE.Vector3,c=new THREE.Vector3;return function(d,e,g){var f=this.elements;c.subVectors(d,e).normalize();0===c.length()&&(c.z=1);a.crossVectors(g,c).normalize();0===a.length()&&(c.x+=1E-4,a.crossVectors(g,c).normalize());b.crossVectors(c,a);f[0]=a.x;f[4]=b.x;f[8]=c.x;f[1]=a.y;f[5]=b.y;f[9]=c.y;f[2]=a.z;
f[6]=b.z;f[10]=c.z;return this}}(),multiply:function(a,b){return void 0!==b?(console.warn("DEPRECATED: Matrix4's .multiply() now only accepts one argument. Use .multiplyMatrices( a, b ) instead."),this.multiplyMatrices(a,b)):this.multiplyMatrices(this,a)},multiplyMatrices:function(a,b){var c=a.elements,d=b.elements,e=this.elements,g=c[0],f=c[4],h=c[8],i=c[12],j=c[1],k=c[5],l=c[9],m=c[13],p=c[2],q=c[6],r=c[10],n=c[14],s=c[3],t=c[7],u=c[11],c=c[15],v=d[0],w=d[4],x=d[8],y=d[12],z=d[1],A=d[5],B=d[9],
...
var b=this.elements;return a.set(b[12],b[13],b[14])}}(),setPosition:function(a){var b=this.elements;b[12]=a.x;b[13]=a.y;b[14]=a.z;return this},getInverse:function(a,b){var c=this.elements,d=a.elements,e=d[0],g=d[4],f=d[8],h=d[12],i=d[1],j=d[5],k=d[9],l=d[13],m=d[2],p=d[6],q=d[10],r=d[14],n=d[3],s=d[7],t=d[11],u=d[15];c[0]=k*r*s-l*q*s+l*p*t-j*r*t-k*p*u+j*q*u;c[4]=h*q*s-f*r*s-h*p*t+g*r*t+f*p*u-g*q*u;c[8]=f*l*s-h*k*s+h*j*t-g*l*t-f*j*u+g*k*u;c[12]=h*k*p-f*l*p-h*j*q+g*l*q+f*j*r-g*k*r;c[1]=l*q*n-k*r*n-
l*m*t+i*r*t+k*m*u-i*q*u;c[5]=f*r*n-h*q*n+h*m*t-e*r*t-f*m*u+e*q*u;c[9]=h*k*n-f*l*n-h*i*t+e*l*t+f*i*u-e*k*u;c[13]=f*l*m-h*k*m+h*i*q-e*l*q-f*i*r+e*k*r;c[2]=j*r*n-l*p*n+l*m*s-i*r*s-j*m*u+i*p*u;c[6]=h*p*n-g*r*n-h*m*s+e*r*s+g*m*u-e*p*u;c[10]=g*l*n-h*j*n+h*i*s-e*l*s-g*i*u+e*j*u;c[14]=h*j*m-g*l*m-h*i*p+e*l*p+g*i*r-e*j*r;c[3]=k*p*n-j*q*n-k*m*s+i*q*s+j*m*t-i*p*t;c[7]=g*q*n-f*p*n+f*m*s-e*q*s-g*m*t+e*p*t;c[11]=f*j*n-g*k*n-f*i*s+e*k*s+g*i*t-e*j*t;c[15]=g*k*m-f*j*m+f*i*p-e*k*p-g*i*q+e*j*q;c=d[0]*c[0]+d[1]*c[4]+
...
new THREE.Vector3,b=new THREE.Vector3,c=new THREE.Vector3,d=new THREE.Matrix4;return function(e,g,f){var h=this.elements;a.set(h[0],h[1],h[2]);b.set(h[4],h[5],h[6]);c.set(h[8],h[9],h[10]);e=e instanceof THREE.Vector3?e:new THREE.Vector3;g=g instanceof THREE.Quaternion?g:new THREE.Quaternion;f=f instanceof THREE.Vector3?f:new THREE.Vector3;f.x=a.length();f.y=b.length();f.z=c.length();e.x=h[12];e.y=h[13];e.z=h[14];d.copy(this);d.elements[0]/=f.x;d.elements[1]/=f.x;d.elements[2]/=f.x;d.elements[4]/=
f.y;d.elements[5]/=f.y;d.elements[6]/=f.y;d.elements[8]/=f.z;d.elements[9]/=f.z;d.elements[10]/=f.z;g.setFromRotationMatrix(d);return[e,g,f]}}(),extractPosition:function(a){var b=this.elements,a=a.elements;b[12]=a[12];b[13]=a[13];b[14]=a[14];return this},extractRotation:function(){var a=new THREE.Vector3;return function(b){var c=this.elements,b=b.elements,d=1/a.set(b[0],b[1],b[2]).length(),e=1/a.set(b[4],b[5],b[6]).length(),g=1/a.set(b[8],b[9],b[10]).length();c[0]=b[0]*d;c[1]=b[1]*d;c[2]=b[2]*d;c[4]=
...
a.b.equals(this.b)&&a.c.equals(this.c)},clone:function(){return(new THREE.Triangle).copy(this)}});
